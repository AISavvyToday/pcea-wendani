...
# Manifest storage is strict and can raise when test templates reference assets
# that are not included in a collected manifest. Use non-manifest storage for tests.
if "test" in sys.argv:
